    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-8 py-10">
      ...
      >
        ...
        <div className="flex-1 text-center sm:text-left">
          <p className="text-amber-400 text-xs font-semibold tracking-widest uppercase mb-1">ScoutAfrica Premium</p>
          <p className="text-white text-lg font-bold">Get discovered faster.</p>
        ...
        <span className="shrink-0 inline-flex items-center gap-1.5 bg-white text-green-800 font-semibold px-5 py-2.5 rounded-xl group-hover:shadow-md transition-shadow">
          Upgrade to Premium <span className="text-green-600" aria-hidden="true">→</span>
        </span>
      </Link>
    </section>
  );
